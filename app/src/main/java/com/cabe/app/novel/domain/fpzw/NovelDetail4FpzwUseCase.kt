 ...
 */
class NovelDetail4FpzwUseCase(private val url: String?) : HttpCacheUseCase<NovelInfo>(object : TypeToken<NovelInfo>() {}, null) {
        ...
        try {
            ...
            doc.select("div.info1 > img")?.let { es ->
                if (es.size > 0) {
                    ...
                    novel?.picUrl = SourceType.FPZW.host + picUrl.substring(1)
                }
            }
